...
public class SendEmailController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String signupFullName = request.getParameter("signupFullName");
            ...
            String signupRole = "USER";

            SendMail sm = new SendMail();
            String code = sm.getRandom();

            UserSendMailDTO user = new UserSendMailDTO(signupEmail, signupFullName, signupPassword, signupAddress, signupBirthday, Integer.parseInt(signupPhone), signupRole, code);
            boolean check = sm.sendEmail(user);
            if (check) {
